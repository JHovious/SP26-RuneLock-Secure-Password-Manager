...
public class Settings {
    ...
    public Settings(LanSyncService lanSync, Runnable onSignOut) {
    ...
    public void showSettings(JSONControl controller) {
        ...
        changeUsername.setOnAction(e -> {
            ...
            result.ifPresent(newName -> {
                ...
                controller.getUser().setUsername(newName);
    ...
    private void showSubUserSelectionWindow(JSONControl controller, String action) {
        ...
        ListView<String> list = new ListView<>();
        for (User.SubUserMeta su : controller.getUser().getSubAccounts()) {
        ...
        confirm.setOnAction(e -> {
            ...
            User.SubUserMeta target = controller.getUser().getSubAccounts()
                    .stream()
